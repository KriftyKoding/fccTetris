...
const scoreWord = document.createElement("h3");
scoreWord.innerText = "Score: ";
domBody.appendChild(scoreWord);
const scoreDisplay = document.createElement("span");
scoreDisplay.id = "score";
scoreDisplay.innerText = "0";
scoreWord.appendChild(scoreDisplay);
...
mingrid.classList = "mini-grid ";
container.appendChild(mingrid);
//mingrid container
let displaySquares = [];
for (let i = 0; i < 16; i++) {
  let girdDiv = document.createElement("div");
  mingrid.appendChild(girdDiv);
  displaySquares.push(girdDiv);
}
